...
function App() {
  ...
  const [photoMode, setPhotoMode] = useState('color')
  ...
  const switchPhotoMode = () => {
    ...
    setPhotoMode((mode) => mode === 'color' ? 'mono' : 'color')
